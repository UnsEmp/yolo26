...
class InverseResidualBlock(nn.Module):
    def __init__(
        ...
        self.conv1 = (
            ConvNormReLUBlock(in_channels, hidden_channels, (1, 1)) if in_channels != hidden_channels else nn.Identity()
...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        self.model = nn.Sequential(ConvNormReLUBlock(input_channel, 32, (3, 3), stride=2, padding=1))

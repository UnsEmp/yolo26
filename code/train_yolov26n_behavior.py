...
def train():
    ...
    train_results = model.train(
        ...
        # patience=50,
        batch=16,
        name="Cow-EatOrChew-train-yolo26n-Cattle_Behavior721_coco",  # Name for the training run, used for saving results
    ...
    fps_list = [[], [], [], []]
    for ep in range(10):
        metrics = model.val(project='Cow-EatOrChew-train-yolo26n-Cattle_Behavior721_coco',
